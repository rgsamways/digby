...
import { Trophy, Star, Share2, Check } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="mb-8 text-center">
        ...
        <button
          onClick={handleShare}
          className="mt-3 inline-flex items-center gap-1.5 rounded-lg border border-stone-200 bg-white px-3 py-1.5 text-xs font-medium text-stone-600 transition hover:border-brand-300 hover:text-brand-600"
        >
          {copied ? (
